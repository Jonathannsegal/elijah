...
export default function Page() {
    ...
    const videoData = [
        { src: "https://xcynaenntclbctlh.public.blob.vercel-storage.com/CameraObscura-7FsgpchugjPZHT4xVZ7vxFPcgUPc66.mp4", title: "Elijah Segal", text: "Writer | Producer | Director | Editor" },
